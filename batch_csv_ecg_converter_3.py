...
# === Configuration ===
file_group = "CSV_ICHT_digitised"
input_directory = "ICHT Digitised pdf ECGs"  # Current directory - change this to your input directory
...
def parse_csv_ecg_file(input_file):
    ...
    try:
        with open(input_file, 'r', newline='', encoding='utf-8', errors='ignore') as csvfile:
            # Use comma as delimiter (known to be consistent)
            delimiter = ','
            print(f"    Using delimiter: '{delimiter}'")
            
            # Method 1: Try using csv.reader with comma delimiter
            try:
